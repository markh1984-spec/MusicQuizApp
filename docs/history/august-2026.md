# History — August 2026, moved whole out of `docs/history.md`

`docs/history.md` passed its 100KB bucket limit on 18 September 2026, with
89% of it the August entries below. They are moved by line number, nothing
reworded: newest first, exactly as they sat under *Current state*. The
current month stays in `docs/history.md`; when it fills, this is the shape
to move it into.
